...
const RenderMember = ({member : {name, email, linkedin, photoKey, position, team}, isLead}) => (name ?
  <div className={`member flex flex-col ${isLead ? 'w-52 md:w-[310px]' : 'w-48 md:w-[195px]'} justify-between`}>
    <div className={`photo ${isLead ? 'w-52 h-48 md:w-[310px] md:h-[300px]' : 'w-48 h-48 md:w-[13vw] md:h-[13vw] lg:w-[14vw] lg:h-[14vw] xl:w-[10vw] xl:h-[10vw]'}`}>
      <img src ={photoMap[photoKey]}/>
    </div>
    <div className={'details flex flex-col'}>
      <div className={'personal flex flex-col px-3 py-2'}>
        <h2 className={`name ${isLead ? 'text-[18px]' : 'text-[16px]'} mb-1`}>{name}</h2>
...
const RenderTeams = () => (
  <div className={'team'}>
    <div className={'leads flex flex-col md:flex-row justify-center mb-4 gap-10'}>
    {
      memberJson.leads.map(lead => <RenderMember member={lead} isLead={true}/>)
    }
    </div>
    <div className={'vps flex flex-col md:flex-row justify-between mb-4'}>
    {
    ...
    </div>
    {
      memberJson.teams.map(team => team.members.map(mem => ({...mem, team:team.name}))).map(team => (
        <div className='team flex flex-col md:flex-row justify-start mb-4'>
        {
